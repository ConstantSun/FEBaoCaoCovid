        ...
        return `
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col">
                            <div class="selectBox">
                                <select class="province-slide8 form-control" id="provinces" name="provinces">
                                    <option selected="true" disabled="disabled" > Tỉnh/huyện</option>
                                </select>
                            </div>
                        </div>
                        <div class="col">

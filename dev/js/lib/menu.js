...
function showThongKeNhomBenh() {
    let str = '';
    str = thongKeNhomBenhController.show();
    document.getElementById("divThongKeNhomBenh").innerHTML = str;
    thongKeNhomBenhController.setup();
}

function showCachLyDiBienDongATCovid() {
    var cachLyDiBienDongATCovidController = new CachLyDiBienDongATCovidController();
    cachLyDiBienDongATCovidController.mount(clicked_province, clicked_district)
}

function showDieuTri() {
    dieuTriController.mount(clicked_province, clicked_district)
}
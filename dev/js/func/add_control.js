      ...
      (feature.properties
        ? "<b>" +
          ...
          (feature.properties.name2
            ? ", <b>" + feature.properties.name2 + "</b>"
            : "") +
          (feature.properties.name1
            ? ", <b>" + feature.properties.name1 + "</b>"
            : "") +
          "<br />" +
          getRisk(sc) +
          "."
...
legend_date.update_time = function (day, counter) {
  ...
  const color = chart_colors[idxs[counter]]["strokeColor"];
...
if (listRegionControler) listRegionControler.addControl(Lmap);

...
function showMoreRowOfTable() {
	...
	// $( "#defaultOpenHanhChinhTab").trigger( "click" );
	// document.getElementById("defaultOpenHanhChinhTab").click();
...
const API_NGUYCO_HOST_V2 = 'https://api.antoancovid.vn/google-syn/api/v2';
function call_host_api_v2(path, parram, callback, name) {
	// Dữ liệu di biến động của từng tỉnh	
	const link = `${API_NGUYCO_HOST_V2}/${path}?${parram}`;
	console.log("CALL APIV2:" + path + "," + parram);
	$.ajax({
		url: link,
		statusCode: {
			404: function () {
